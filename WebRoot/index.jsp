...
<link rel='stylesheet prefetch' href='http://multiplier.in/css/base.css'>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="#section-2" class="hidden-xs">成功案例</a></li>
  ...
  <div class="page wow fadeInLeft" id="section-2">
    ...
    <div class="container">
      <div class="col-lg-offset-2 col-lg-8 col-md-offset-1 col-md-10 col-xs-12">
        <p>A brilliant business idea should thrive, grow and prosper. It should not fade away for lack of funds, staff or the right support.
          <br>
          <br><strong>An Idea Never Stops, It Multiplies.</strong>
          <br> So we give you Multiplier. A social but business oriented platform where people can come together to create, develop and grow their startups.
          <br>
          <br> So if you want to invest in a startup, if you want to work in a startup or if you are a budding entrepreneur.
          <br>
          <br><strong>We Welcome You Aboard To Multiplier.</strong></p>
